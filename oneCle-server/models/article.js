...
const lecture = {
  ...
  createLecture: async (
    ...
    const fields =
      'lectureName, color, orgLocation, bank, accountNo, depositCycle, price, code';
    const questions = `?, ?, ?, ?, ?, ?, ?, ?`;
    const values = [
      lectureName,
      color,
  ...
  createClassAuto: async (
    ...
    const fields =
      'startTime, endTime, hour, times, location, classDate, lecture_lectureId';
    const questions = `?, ?, ?, ?, ?, ?, ?`;
    const values = [
      startTime,
      endTime,
